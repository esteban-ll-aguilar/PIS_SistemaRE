...
export const Graficas = () => {
  return (
    <div>
      ...
      <div className="card col-span-1 md:col-span-2 lg:col-span-3 p-4" style={{ backgroundColor: 'white', borderRadius: '12px' }}>
        <div className="stat">
      ...
      <div className="card col-span-1 mt-4 md:col-span-2 lg:col-span-3 p-3 color" style={{ backgroundColor: 'white', borderRadius: '12px' }}>
