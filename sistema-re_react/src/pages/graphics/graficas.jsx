...
export const Graficas = () => {
  return (
    <div>
      ...
      <div className=" bg-white card col-span-1 md:col-span-2 lg:col-span-3 p-4 dark:bg-teal-800 dark:text-white " style={{  borderRadius: '12px' }}>
        <div className="stat dark:bg-teal-800">
      ...
      <div className="  bg-white  card col-span-1 mt-4 md:col-span-2 lg:col-span-3 p-3 color  dark:bg-teal-800 dark:text-white " style={{ borderRadius: '12px' }}>
    ...
    <div className="dashboard grid  md:grid-cols-2 lg:grid-cols-2 gap-4 p-4">
      <div className="card p-4 rounded-md bg-white dark:bg-teal-800 " >
        <div className="stat">
      ...
      <div className="card p-4" style={{ backgroundColor: 'white', borderRadius: '12px' }}>
        <div className="stat">
      ...
      <div className="card p-4" style={{ backgroundColor: 'white', borderRadius: '12px' }}>
        <div className="stat">
          <h2 className='text-center font-bold'>Requisitos dde Software</h2>
          <GraficasUnidad></GraficasUnidad>
        </div>
        <div className="chart"></div>
      </div>
